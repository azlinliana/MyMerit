 ...
 *   https://datatables.net/download/#bs4/dt-1.10.21/b-1.6.2/r-2.2.5/sp-1.1.1
 *
 * Included libraries:
 *   DataTables 1.10.21, Buttons 1.6.2, Responsive 2.2.5, SearchPanes 1.1.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.21/b-1.6.2/r-2.2.5/sp-1.1.1",
